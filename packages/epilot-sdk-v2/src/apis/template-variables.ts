...
export type { Client, PathsDictionary, OperationMethods, CategoryResult, CustomVariable, CustomVariablesSearchParams, ExternalCustomVariable, Language, ReplacementOutput, ReplacementOutputV2, TemplateType, VariableContext, VariableParameters, VariableResult } from '../types/template-variables'

/* eslint-disable @typescript-eslint/no-require-imports */
const loadDefinition = (): Document => {
  const mod = require('../definitions/template-variables.json')
