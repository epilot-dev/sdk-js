...
export type { Client, PathsDictionary, OperationMethods, Caller, Event, HttpContext, SearchOptions } from '../types/audit-logs'

/* eslint-disable @typescript-eslint/no-require-imports */
const loadDefinition = (): Document => {
  const mod = require('../definitions/audit-logs.json')
