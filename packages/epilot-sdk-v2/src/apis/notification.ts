...
export type { Client, PathsDictionary, OperationMethods, CreateNotificationTemplateInput, Entity, EntityAcl, EntityId, EntityOperation, EntityOwner, EntitySlug, Error, Id, Notification, NotificationBase, NotificationCallerContext, NotificationId, NotificationItem, NotificationTemplate, NotificationTemplateListResponse, SendPreviewInput, SendPreviewResponse, UpdateNotificationTemplateInput } from '../types/notification'

/* eslint-disable @typescript-eslint/no-require-imports */
const loadDefinition = (): Document => {
  const mod = require('../definitions/notification-runtime.json')
