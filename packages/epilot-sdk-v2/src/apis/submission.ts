...
export type { Client, PathsDictionary, OperationMethods, OptIn, S3Reference, SubmissionEntity, SubmissionNonce, SubmissionPayload } from '../types/submission'

/* eslint-disable @typescript-eslint/no-require-imports */
const loadDefinition = (): Document => {
  const mod = require('../definitions/submission-runtime.json')
