...
import type { Client } from '../types/discussion'
export type { Client, PathsDictionary, OperationMethods, Attachment, BaseEntity, Comment, Reaction, User } from '../types/discussion'
 ...
 * `discussion.someOperation(...)` calls forwarded to lazy singleton
 */
export const discussion = _handle