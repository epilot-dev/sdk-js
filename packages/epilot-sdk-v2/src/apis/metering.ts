...
export type { Client, PathsDictionary, OperationMethods, ActionLabel, ActivityId, BaseEntity, CounterReadingOnSubmission, Direction, Entity, EntityId, EntityItem, EntityRelation, EntitySlug, ErrorResp, Id, JourneyActions, Meter, MeterCounter, MeterReading, PortalMeterReading, ReadBy, Reading, ReadingStatus, ReadingWithMeter, Reason, ReasonString, Rule, Source, SubmissionMeterReading, TariffType, Unit, UpdateMeterReading } from '../types/metering'

/* eslint-disable @typescript-eslint/no-require-imports */
const loadDefinition = (): Document => {
  const mod = require('../definitions/metering-runtime.json')
