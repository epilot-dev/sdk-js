...
import type { Client } from '../types/sandbox'
export type { Client, PathsDictionary, OperationMethods, AccessToken, CreatePipelineRequest, OrgId, Pipeline, PipelineId, PipelineItem, PipelineRole, PipelineToken, SandboxRequest, SandboxToken } from '../types/sandbox'

/* eslint-disable @typescript-eslint/no-require-imports */
const loadDefinition = (): Document => {
  const mod = require('../definitions/sandbox-runtime.json')
