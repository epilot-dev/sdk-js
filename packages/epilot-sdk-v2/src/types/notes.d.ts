...
declare namespace Components {
  namespace Schemas {
    ...
    export interface NoteContexts {
      type: ContextType;
      context: /* Base Entity schema */
        | Entity
        | /* Base metadata for a Workflow Execution. This is a lightweight representation of a Workflow Execution, and does not contain all it's data */ WorkflowExecution;
    }
    /**
...
declare namespace Paths {
  namespace AddNoteReaction {
    ...
    namespace Responses {
      export type $200 =
        /* A note Entity object cotaining Entity metadata and content. Relational attributes are hydrated in place. */ Components.Schemas.NoteEntity;
    }
  }
  ...
  namespace GetNoteContexts {
    ...
    namespace Responses {
      export type $200 =
        /* List of resolved Entity and non-Entity contexts attached to a given Note. */ Components.Schemas.NoteContexts[];
    }
  }
