...
declare namespace Components {
  namespace Schemas {
    ...
    export type MappingSourceTargetType =
      | 'string'
      | 'date'
      | 'datetime'
      | 'boolean'
    ...
    export type OperationNode =
      /* Mapping operation nodes are either primitive values or operation node objects */
      OperationObjectNode | /* Represents any primitive JSON value */ PrimitiveJSONValue;
...
declare namespace Paths {
  ...
  namespace ExecuteRelations {
    export type RequestBody =
      /* Build relations between a source entity and one or more target entities, dynamically identified */ Components.Schemas.ExecuteRelationsReq;
    namespace Responses {
