...
export interface OperationMethods {
  ...
  getAllowedReadingForMeter(
    parameters?: Parameters<
      Paths.GetAllowedReadingForMeter.QueryParameters & Paths.GetAllowedReadingForMeter.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
  ...
  getReadingsByInterval(
    parameters?: Parameters<
      Paths.GetReadingsByInterval.QueryParameters & Paths.GetReadingsByInterval.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
...
export interface PathsDictionary {
  ...
  ['/v1/metering/reading/{meter_id}/{counter_id}']: {
    ...
    put(
      parameters?: Parameters<
        Paths.UpdateMeterReading.QueryParameters & Paths.UpdateMeterReading.PathParameters
      > | null,
      data?: Paths.UpdateMeterReading.RequestBody,
      config?: AxiosRequestConfig,
    ): OperationResponse<Paths.UpdateMeterReading.Responses.$200>;
    ...
    delete(
      parameters?: Parameters<
        Paths.DeleteMeterReading.QueryParameters & Paths.DeleteMeterReading.PathParameters
      > | null,
      data?: any,
      config?: AxiosRequestConfig,
    ): OperationResponse<Paths.DeleteMeterReading.Responses.$200>;
