...
declare namespace Components {
  namespace Schemas {
    ...
    export type ComputePriceParams =
      /* The compute price payload */ /* The compute price payload for power */
      ComputePriceParamsPower | /* The compute price payload for gas */ ComputePriceParamsGas;
    ...
    export type ConsumptionTypeGetAg =
      | 'household'
      | 'heating_pump'
     ...
     */ & /* The request payload for the external catalog service with a journey context. */ (
      ...
      | /* The request payload for the external catalog service with a portal context. */ ExternalCatalogPortalRequest
      | /* The request payload for the external catalog service with a custom context. E.g. for requests from the Portal. */ ExternalCatalogCustomRequest
    );
    /**
     * example:
     * {
     ...
     */
    export type IntegrationAuthCredentials =
      /* The auth credentials for external integrations */ BasicAuthIntegration | OAuthIntegration;
    export type IntegrationCredentialsResult =
      /* The auth credentials for external integrations */ IntegrationAuthCredentials;
    ...
    export interface Price {
      ...
      unit?: /* The unit of measurement used for display purposes and possibly for calculations when the price is variable. */
        | ('kw' | 'kwh' | 'm' | 'm2' | 'l' | 'cubic-meter' | 'cubic-meter-h' | 'ls' | 'a' | 'kva' | 'w' | 'wp' | 'kwp')
        | string;
      get_ag?: PriceGetAg;
    ...
    export type PriceItemDtoUnion =
      /* Represents a price input to the pricing library. */
      PriceItemDto | /* Represents a composite price input to the pricing library. */ CompositePriceItemDto;
    /**
    ...
    export type SaveIntegrationCredentialsParams =
      /* The auth credentials for external integrations */ IntegrationAuthCredentials;
...
declare namespace Paths {
  ...
  namespace $AverageMarketPrice {
    namespace Parameters {
      export type BiddingZone =
        /* The bidding zone for a spot market price. */ Components.Schemas.SpotMarketBiddingZone;
  ...
  namespace $CalculatePricingDetails {
    ...
    namespace Responses {
      export type $200 =
        /* The result from the calculation of a set of price items. */ Components.Schemas.PricingDetailsResponse;
      export type $400 = Components.Schemas.Error;
    }
  }
  ...
  namespace $HistoricMarketPrices {
    namespace Parameters {
      ...
      export type Frequency =
        /* The aggregation frequency for a series of spot market price data. */ Components.Schemas.SpotMarketDataFrequency;
      export type From = string /* date */ | string /* date-time */;
      export type Market = /* The market for a spot market price. */ Components.Schemas.SpotMarketType;
      export type To = string /* date */ | string /* date-time */;
    }
  ...
  namespace $ProductRecommendations {
    ...
    export type RequestBody =
      /* Product recommendations request payload */ Components.Schemas.ProductRecommendationSearch;
    namespace Responses {
  ...
  namespace $ValidatePromoCodes {
    ...
    namespace Responses {
      export type $200 =
        /* The result from the validation of a set of promo codes. */ Components.Schemas.PromoCodeValidationResponse;
      export type $400 = Components.Schemas.Error;
    }
  }
...
export interface OperationMethods {
  ...
  $validateAvailabilityFile(
    parameters?: Parameters<
      Paths.$ValidateAvailabilityFile.HeaderParameters & Paths.$ValidateAvailabilityFile.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
