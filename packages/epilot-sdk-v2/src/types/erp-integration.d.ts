...
declare namespace Components {
  ...
  namespace Schemas {
    ...
    export interface FileProxyUrlParams {
      [
        name: string
      ]: /* Parameter for file proxy URL. Exactly one of field, constant, or jsonataExpression must be set. */ FileProxyUrlParam;
    }
    ...
    export interface FileProxyUseCaseConfiguration {
       ...
       */
      steps: [FileProxyStep, ...FileProxyStep[]];
    ...
    export interface IntegrationConfigurationV2 {
      ...
      mapping: {
        ...
        events: {
          [
            name: string
          ]: /* Configuration for inbound use cases (ERP to epilot) */ InboundIntegrationEventConfiguration;
        };
      };
    }
    ...
    export interface MappingSimulationV2Request {
       ...
       */
      payload: /* The event data payload - can be either a serialized string or a direct JSON object */
        | string
        | {
            [name: string]: any;
          };
    ...
    export interface MeterUniqueIdsConfig {
       ...
       */
      unique_ids: [RelationUniqueIdField, ...RelationUniqueIdField[]];
    }
    ...
    export type UseCaseHistoryEntry =
...
declare namespace Paths {
  ...
  namespace CreateIntegrationV2 {
    ...
    namespace Responses {
      export type $201 =
        /* Integration with embedded use cases for atomic CRUD operations */ Components.Schemas.IntegrationWithUseCases;
      export type $400 = Components.Responses.BadRequest;
      export type $401 = Components.Responses.Unauthorized;
      export type $500 = Components.Responses.InternalServerError;
    }
  ...
  ['/v1/integrations/{integrationId}/use-cases/{useCaseId}/history']: {
    ...
    get(
      parameters?: Parameters<
        Paths.ListUseCaseHistory.QueryParameters & Paths.ListUseCaseHistory.PathParameters
      > | null,
      data?: any,
      config?: AxiosRequestConfig,
    ): OperationResponse<Paths.ListUseCaseHistory.Responses.$200>;
