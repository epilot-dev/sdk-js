...
declare namespace Components {
  ...
  namespace Schemas {
    ...
    export type AnyAction =
      ...
      | SendEmailAction
      | /* Creates an order entity with prices from journey */ CartCheckoutAction
      | CustomAction
      | AutomationAction
    ...
    export type AnyActionConfig =
      ...
      | /* Creates an order entity with prices from journey */ CartCheckoutActionConfig
      | CustomAction
    ...
    export type FilterConditionOnEvent =
      | OrCondition
      | {
          [name: string]: (
            | string
    ...
    export type OperationNode =
      /* Mapping operation nodes are either primitive values or operation node objects */
      OperationObjectNode | PrimitiveJSONValue;
