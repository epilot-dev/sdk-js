...
declare namespace Components {
  namespace Schemas {
    ...
    export interface AiAgentTask {
      ...
      assigned_to?: (
        | string
        | /* Represents a variable assignment with its expression and optional resolved value. Used for dynamic user assignments that get resolved during workflow execution. */ VariableAssignment
      )[];
    ...
    export interface WorkflowDefinition {
      ...
      flow: /* A group of Steps that define the progress of the Workflow */ (
        | Section
        | /* Action that needs to be done in a Workflow */ Step
      )[];
