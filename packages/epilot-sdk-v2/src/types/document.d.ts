...
declare namespace Components {
  namespace Schemas {
    ...
    export interface ErrorOutput {
       ...
       */
      ErrorCode;
      error_details?: /* Error details for invalid custom variables. This error will appear under 'PARSE_ERROR' error code. */
        | InvalidCustomVariableErrorDetails
        | /* Error details for internal error. This error will appear under 'INTERNAL_ERROR' error code. */ InternalErrorDetails /**
         * Error details for DocxTemplater error. This error will appear under 'PARSE_ERROR' error code.
         * See https://docxtemplater.com/docs/errors/#error-schema for more details.
         *
         */
