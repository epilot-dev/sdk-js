...
declare namespace Components {
  ...
  namespace Responses {
    ...
    export type CreateEmailAddressSuccessResponse =
      /* Email address configuration with all associated metadata. */ Schemas.EmailAddressResponse;
    export type CreateSharedInboxSuccessResponse =
      /* Shared inbox configuration with all associated metadata. */ Schemas.SharedInboxResponse;
    export type Forbidden = /* Standard error response format for all API errors. */ Schemas.ErrorResponse;
    export type GetEmailAddressSuccessResponse =
      /* Email address configuration with all associated metadata. */ Schemas.EmailAddressResponse;
    export type GetSharedInboxSuccessResponse =
      /* Shared inbox configuration with all associated metadata. */ Schemas.SharedInboxResponse;
    export type InternalServerError = /* Standard error response format for all API errors. */ Schemas.ErrorResponse;
    export type ListEmailAddressesSuccessResponse =
      /* Email address configuration with all associated metadata. */ Schemas.EmailAddressResponse[];
    export type ListInboxBucketsSuccessResponse =
      /* Inbox bucket representing the storage container for a shared inbox. */ Schemas.InboxBucketResponse[];
    export type ListSharedInboxesSuccessResponse =
      /* Shared inbox configuration with all associated metadata. */ Schemas.SharedInboxResponse[];
    ...
    export type ProvisionEpilotEmailAddressSuccessResponse =
      /* Email address configuration with all associated metadata. */ Schemas.EmailAddressResponse;
    export type SetEmailAddressPrimarySuccessResponse =
      /* Email address configuration with all associated metadata. */ Schemas.EmailAddressResponse;
    export type UpdateEmailAddressSuccessResponse =
      /* Email address configuration with all associated metadata. */ Schemas.EmailAddressResponse;
    export type UpdateSharedInboxSuccessResponse =
      /* Shared inbox configuration with all associated metadata. */ Schemas.SharedInboxResponse;
  }
  namespace Schemas {
    /**
    ...
    export type SettingType =
      ...
      | SignatureSetting
      | /* Setting that allows to add a custom domain. For e.g; doe.com */ EmailDomainSetting
      | /* Setting that allows to add an email address on the custom domain. For e.g; john@doe.com */ EmailAddressSetting /**
...
declare namespace Paths {
  ...
  namespace AddEmailAddress {
    export type RequestBody =
      /* Request payload for creating a new email address. */ Components.Schemas.CreateEmailAddressPayload;
    namespace Responses {
  ...
  namespace AddSharedInbox {
    export type RequestBody =
      /* Request payload for creating a new shared inbox. */ Components.Schemas.CreateSharedInboxPayload;
    namespace Responses {
  ...
  namespace ProvisionEpilotEmailAddress {
    export type RequestBody =
      /* Request payload for provisioning an epilot-managed email address. */ Components.Schemas.ProvisionEpilotEmailAddressPayload;
    namespace Responses {
  ...
  namespace SetEmailAddressPrimary {
    export type RequestBody =
      /* Request payload for setting an email address as the organization's primary address. */ Components.Schemas.SetEmailAddressPrimaryPayload;
    namespace Responses {
