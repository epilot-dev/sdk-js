...
declare namespace Components {
  namespace Schemas {
    ...
    export type NavigationItem =
      /* A navigation item - either a simple key item or a group with sub-items */ /* A simple navigation item with a key */
      NavigationKeyItem | /* A navigation group containing sub-items */ NavigationGroupItem;
    /**
...
declare namespace Paths {
  ...
  namespace CreateNavigation {
    export type RequestBody =
      /* Request payload to create a new navigation configuration */ Components.Schemas.NavigationCreateRequest;
    namespace Responses {
      export type $201 =
        /* A customized workplace navigation configuration. The ID is a content-hash, so identical configurations will have the same ID. */ Components.Schemas.Navigation;
    }
  }
