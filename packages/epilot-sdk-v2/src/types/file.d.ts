...
export declare namespace Components {
    ...
    namespace Schemas {
         ...
         *
         */
        export type CreateZipJobPayload = /**
         * Request payload to create a ZIP job for bulk file download.
         * Provide either an explicit list of `file_entity_ids` (up to 1000) or an
         * `entity_query` that resolves to file entities (up to 10000).
         *
         */
        {
            ...
            entity_query?: {
                 ...
                 * example:
                 * _schema:file AND _tags:invoice
                 */
                q: string;
                /**
        ...
        export interface ZipJob {
            ...
            result?: {
                 ...
                 * example:
                 * https://epilot-prod-user-content.s3.eu-central-1.amazonaws.com/123/files.zip?X-Amz-...
                 */
             ...
             * example:
             * Failed to download file: access denied
             */
            error?: string;
            /**
...
export declare namespace Paths {
    ...
    namespace CreateZipJob {
         ...
         *
         */
        Components.Schemas.CreateZipJobPayload;
        namespace Responses {
            export type $202 = /* ZIP job status and result */ Components.Schemas.ZipJob;
            export type $400 = /**
             * A generic error returned by the API
             * example:
             * {
    ...
    namespace GetZipJob {
        ...
        namespace Responses {
            export type $200 = /* ZIP job status and result */ Components.Schemas.ZipJob;
            export type $401 = /**
             * A generic error returned by the API
             * example:
             * {
...
export interface OperationMethods {
  ...
  'createZipJob'(
    parameters?: Parameters<UnknownParamsObject> | null,
    data?: Paths.CreateZipJob.RequestBody,
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.CreateZipJob.Responses.$202>
  /**
   * getZipJob - getZipJob
   * 
   ...
   */
  'getZipJob'(
    parameters?: Parameters<Paths.GetZipJob.PathParameters> | null,
    data?: any,
    config?: AxiosRequestConfig  
...
export type ZipJob = Components.Schemas.ZipJob;
