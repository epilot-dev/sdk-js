...
declare namespace Components {
  ...
  namespace Schemas {
    ...
    export type BillingEvent = {
       ...
       */
      billing_amount_decimal?: string;
    } & /* An entity that describes a billing event such as a future installment or a reimbursement back to the customer. */ /* An entity that describes an installment billing event. */ (
      | InstallmentEvent
      | /* An entity that describes a reimbursement billing event. */ ReimbursementEvent
    );
    ...
    export interface EmailTemplates {
      ...
      EntityId /* uuid */;
      /**
       * ID of the email template for setting password while verifying code
       */
    ...
    export type PortalUserRegistrationStatus =
...
declare namespace Paths {
    ...
    namespace Responses {
      export interface $200 {
        ...
        results?: ({
          ...
          | /* The order entity */ Components.Schemas.Order
        ))[];
      }
      export type $401 = Components.Responses.Unauthorized;
      export type $403 = Components.Responses.Forbidden;
  ...
  namespace GetEmailTemplates {
    ...
    namespace Responses {
      export type $200 =
        /* Email templates used for authentication and internal processes */ Components.Schemas.EmailTemplates;
      export type $401 = Components.Responses.Unauthorized;
      export type $403 = Components.Responses.Forbidden;
      export type $500 = Components.Responses.InternalServerError;
    }
  ...
  namespace SearchPortalUserEntities {
    ...
    namespace Responses {
      export type $200 =
        /* Response for entity search requests */
        | Components.Schemas.EntityResponseWithHits
        | /* Response for entity search requests, but with groupings */ Components.Schemas.EntityResponseGroupedWithHits;
      export type $401 = Components.Responses.Unauthorized;
      export type $403 = Components.Responses.Forbidden;
      export type $404 = Components.Responses.NotFound;
      export type $500 = Components.Responses.InternalServerError;
...
export interface OperationMethods {
  ...
  getResolvedExternalLink(
    parameters?: Parameters<
      Paths.GetResolvedExternalLink.QueryParameters & Paths.GetResolvedExternalLink.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
  ...
  getResolvedExternalLinkV3(
    parameters?: Parameters<
      Paths.GetResolvedExternalLinkV3.QueryParameters & Paths.GetResolvedExternalLinkV3.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
  ...
  confirmUserWithUserId(
    parameters?: Parameters<
      Paths.ConfirmUserWithUserId.QueryParameters & Paths.ConfirmUserWithUserId.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
  ...
  validateCadenceEntityEditRules(
    parameters?: Parameters<
      Paths.ValidateCadenceEntityEditRules.QueryParameters & Paths.ValidateCadenceEntityEditRules.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
  ...
  triggerEntityAccessEvent(
    parameters?: Parameters<
      Paths.TriggerEntityAccessEvent.QueryParameters & Paths.TriggerEntityAccessEvent.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
  ...
  triggerEntityAccessEventV3(
    parameters?: Parameters<
      Paths.TriggerEntityAccessEventV3.QueryParameters & Paths.TriggerEntityAccessEventV3.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
  ...
  getAllowedMeterReadingRange(
    parameters?: Parameters<
      Paths.GetAllowedMeterReadingRange.QueryParameters & Paths.GetAllowedMeterReadingRange.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
