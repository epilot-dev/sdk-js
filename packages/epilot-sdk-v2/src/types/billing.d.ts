/* Auto-copied from billing-client */
/* eslint-disable */
...
declare namespace Components {
  namespace Schemas {
    ...
    export type BillingEvent =
      ...
      InstallmentEvent | /* An entity that describes a reimbursement billing event. */ ReimbursementEvent;
...
declare namespace Paths {
  namespace CreateBillingEvent {
    ...
    export type RequestBody =
      /* An entity that describes a billing event such as a future installment or a reimbursement back to the customer. */ /* An entity that describes an installment billing event. */
      | Components.Schemas.InstallmentEvent
      | /* An entity that describes a reimbursement billing event. */ Components.Schemas.ReimbursementEvent;
    namespace Responses {
      /**
       * An entity that describes a billing event such as a future installment or a reimbursement back to the customer.
       */
  ...
  namespace GetBillingEvent {
    ...
    namespace Responses {
      export type $200 =
        /* An entity that describes a billing event such as a future installment or a reimbursement back to the customer. */ Components.Schemas.BillingEvent;
    }
  }
