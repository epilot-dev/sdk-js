...
declare namespace Components {
  ...
  namespace Schemas {
    ...
    export type Attribute =
      ...
      | TextAttribute
      | /* Link with title and href */ LinkAttribute
      | /* Date or Datetime picker */ DateAttribute
      | /* Country picker */ CountryAttribute
      | /* Yes / No Toggle */ BooleanAttribute
      | /* Dropdown select */ SelectAttribute
      | /* Multi Choice Selection */ MultiSelectAttribute
      | /* Status select */ StatusAttribute
      | /* Sequence of unique identifiers */ SequenceAttribute
      | /* Entity Relationship */ RelationAttribute
      | /* User Relationship */ UserRelationAttribute
      | /* Address attribute */ AddressAttribute
      | /* Reference to an address attribute of another entity */ AddressRelationAttribute
      | /* Reference to a payment method attribute of another entity */ PaymentMethodRelationAttribute
      | /* Currency input */ CurrencyAttribute
      | /* Tags */ TagsAttribute
      | /* Message emil address */ MessageEmailAddressAttribute
      | /* Numeric input */ NumberAttribute
      | /* Consent Management */ ConsentAttribute
      | /* No UI representation */ InternalAttribute
      | /* Type of attribute to render N number of ordered fields */ OrderedListAttribute
      | /* File or Image Attachment */ FileAttribute
      | /* An attribute that is computed from the entity data. For more details on how to use them, check the docs [here](https://e-pilot.atlassian.net/wiki/spaces/EO/pages/5642977476/How+To+Computed+Schema+Attributes) */ ComputedAttribute
      | /* Partner Status */ PartnerStatusAttribute
      | /* Email address for send invitation */ InvitationEmailAttribute
      | /* Automation entity */ AutomationAttribute
      | /* Epilot internal user info */ InternalUserAttribute
      | /* Entity Taxonomy */ PurposeAttribute
      | /* Shared Partner Organisations */ PartnerOrganisationAttribute
      | /* Portal access configuration */ PortalAccessAttribute
      | /* Phone number */ PhoneAttribute
      | /* Email address */ EmailAttribute
      | /* Payment method */ PaymentAttribute
      | /* Price component */ PriceComponentAttribute;
    /**
    ...
    export type AttributeWithCompositeID = {
       ...
       */
      schema?: string;
    } & /* a readonly computed ID for the attribute including schema slug and the attribute ID */ /* Textarea or text input */ (
      | TextAttribute
      | /* Link with title and href */ LinkAttribute
      | /* Date or Datetime picker */ DateAttribute
      | /* Country picker */ CountryAttribute
    ...
    export type EntityValidationResult =
      ...
      EntityValidationResultSuccess | /* Validation result for a failed validation */ EntityValidationResultError;
    /**
    ...
    export type EntityValidationV2Result =
      /* Validation result for a successful validation */
      EntityValidationV2ResultSuccess | /* Validation result for a failed validation */ EntityValidationV2ResultError;
    /**
     * Validation result for a failed validation
     */
    export interface EntityValidationV2ResultError {
      status: 'error';
      errors: [EntityValidationV2Error, ...EntityValidationV2Error[]];
    }
    /**
     * Validation result for a successful validation
     */
    ...
    export interface RelationAttribute {
      ...
      summary_fields?: (
        | string
        | /* Summary Fields are displayed inside list view as a resume of the relation entity. */ SummaryField
      )[];
      allowedSchemas?: /**
       * URL-friendly identifier for the entity schema
       * example:
    ...
    export type TaxonomyLocationId =
      | 'account'
      | 'contact'
      | 'contract'
      | 'email_template'
...
declare namespace Paths {
  ...
  namespace CreateEntity {
    ...
    namespace Responses {
      ...
      export type $422 =
        /* Validation result for a failed validation */ Components.Schemas.EntityValidationV2ResultError;
      export type $429 =
        /**
         * A generic error returned by the API
         * example:
  ...
  namespace CreateSchemaAttribute {
    export type RequestBody =
      /* a readonly computed ID for the attribute including schema slug and the attribute ID */ Components.Schemas.AttributeWithCompositeID;
    namespace Responses {
      export type $201 =
        /* a readonly computed ID for the attribute including schema slug and the attribute ID */ Components.Schemas.AttributeWithCompositeID;
      export type $429 =
  ...
  namespace CreateSchemaCapability {
    export type RequestBody =
      /* a readonly computed ID for the entity capability including schema slug and the capability ID */ Components.Schemas.EntityCapabilityWithCompositeID;
    namespace Responses {
      export type $201 =
        /* a readonly computed ID for the entity capability including schema slug and the capability ID */ Components.Schemas.EntityCapabilityWithCompositeID;
      export type $429 =
  ...
  namespace CreateSchemaGroup {
    export type RequestBody =
      /* a readonly computed ID for the group including schema slug and the group ID */ Components.Schemas.EntitySchemaGroupWithCompositeID;
    namespace Responses {
      export type $201 =
        /* a readonly computed ID for the group including schema slug and the group ID */ Components.Schemas.EntitySchemaGroupWithCompositeID;
      export type $429 =
  ...
  namespace CreateSchemaGroupHeadline {
    export type RequestBody =
      /* a readonly computed ID for the entity group headline including schema slug and the headline ID */ Components.Schemas.GroupHeadlineWithCompositeID;
    namespace Responses {
      export type $201 =
        /* a readonly computed ID for the entity group headline including schema slug and the headline ID */ Components.Schemas.GroupHeadlineWithCompositeID;
      export type $429 =
  ...
  namespace GetSchema {
    ...
    namespace Responses {
      export type $200 =
        /* The "type" of an Entity. Describes the shape. Includes Entity Attributes, Relations and Capabilities. */ Components.Schemas.EntitySchemaItem;
      export type $404 =
        /**
         * A generic error returned by the API
         * example:
  ...
  namespace PutSchema {
    ...
    export type RequestBody =
      /* The "type" of an Entity. Describes the shape. Includes Entity Attributes, Relations and Capabilities. */ Components.Schemas.EntitySchema;
    namespace Responses {
      export type $200 =
        /* The "type" of an Entity. Describes the shape. Includes Entity Attributes, Relations and Capabilities. */ Components.Schemas.EntitySchemaItem;
      export type $429 =
  ...
  namespace ValidateEntity {
    ...
    namespace Responses {
      export type $200 =
        /* Validation result for a successful validation */ Components.Schemas.EntityValidationResultSuccess;
  ...
  namespace ValidateEntityV2 {
    ...
    namespace Responses {
      export type $200 =
        /* Validation result for a successful validation */ Components.Schemas.EntityValidationV2ResultSuccess;
      export type $422 =
        /* Validation result for a failed validation */ Components.Schemas.EntityValidationV2ResultError;
      export type $429 =
        /**
...
export interface OperationMethods {
  ...
  getEntityActivityFeed(
    parameters?: Parameters<
      Paths.GetEntityActivityFeed.QueryParameters & Paths.GetEntityActivityFeed.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
  ...
  getRelatedEntitiesCount(
    parameters?: Parameters<
      Paths.GetRelatedEntitiesCount.QueryParameters & Paths.GetRelatedEntitiesCount.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
  ...
  taxonomyAutocomplete(
    parameters?: Parameters<
      Paths.TaxonomyAutocomplete.QueryParameters & Paths.TaxonomyAutocomplete.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
  ...
  listTaxonomyClassificationsForSchema(
    parameters?: Parameters<
      Paths.ListTaxonomyClassificationsForSchema.QueryParameters &
        Paths.ListTaxonomyClassificationsForSchema.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig,
