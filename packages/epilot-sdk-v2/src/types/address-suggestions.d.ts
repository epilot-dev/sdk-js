...
declare namespace Paths {
  ...
  namespace ValidateAddresses {
    ...
    namespace Responses {
      export type $200 =
        /* The availability map file result payload */ Components.Schemas.ValidateAddressSuggestionsFileResult;
      export type $400 = Components.Schemas.Error;
    }
  }
  ...
  ['/v1/public/availability:check']: {
    ...
    get(
      parameters?: Parameters<
        Paths.CheckAvailability.QueryParameters & Paths.CheckAvailability.HeaderParameters
      > | null,
      data?: any,
      config?: AxiosRequestConfig,
    ): OperationResponse<Paths.CheckAvailability.Responses.$200>;
