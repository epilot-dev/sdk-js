...
- [`getSchema`](#getschema) — Gets the latest version of the Schema.
...
| `latest` | query | boolean | No | No longer has any effect: schema freezing is retired and the latest version is always returned.
 |
