...
export const main = defineCommand({
  ...
  subCommands: {
    ...
    chat: () => import('./commands/apis/chat.js').then((m) => m.default),
    ...
    identity: () => import('./commands/apis/identity.js').then((m) => m.default),
    ...
    snapshot: () => import('./commands/apis/snapshot.js').then((m) => m.default),
