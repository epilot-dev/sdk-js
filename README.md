...
| `epilot.calendar` | `@epilot/sdk/calendar` | [docs](./packages/epilot-sdk-v2/docs/calendar.md) |
| `epilot.chat` | `@epilot/sdk/chat` | [docs](./packages/epilot-sdk-v2/docs/chat.md) |
...
| `epilot.snapshot` | `@epilot/sdk/snapshot` | [docs](./packages/epilot-sdk-v2/docs/snapshot.md) |
